...
<head>
    ...
    <!-- <link rel="preload" href="{{ URL::to('website/assets/css/style.min.css') }}" as="style">
    <link rel="preload" href="{{ URL::to('website/assets/js/script.min.js') }}" as="script"> -->
    <meta charset="utf-8">
    ...
    <link href="{{ asset('website/assets/css/style.min.css') }}" rel="stylesheet">
    <link href="{{ asset('website/assets/css/custom.min.css') }}" rel="stylesheet">
...
<body id="page-top" class="h-100 w-100">
    ...
    <section id="hero" class="bg-img-cover bg-overlay position-relative" style="height: 500px;">
        <div class="container">
            <div class="row g-0 justify-content-center justify-content-lg-start">
                ...
                <div class="col-md-3">
                    <!-- <a href="https://muslimmatrimonywell.com/" target="_blank" class="btn btn-primary" style="margin-top: 300px;margin-left: 700px;color:white;">Our App</a> -->

                    <a href="https://muslimmatrimonywell.com/" target="_blank" class="btn btn-success" >
                        Our App</a>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center gx-lg-5 justify-content-center">
                ...
                <div class="col-lg-7">
                    ...
                    <form action="https://demo.lucky-roo.com/dahlia-v1.0/rsvp.php" method="post">
    ...
    <script src="{{ asset('public/website/assets/js/script.min.js') }}"></script>
</body>
